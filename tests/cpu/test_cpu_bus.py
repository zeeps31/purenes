...
def test_read_from_ram(cpu_bus: purenes.cpu.CPUBus):
...
def test_write_to_ram(cpu_bus: purenes.cpu.CPUBus):
...
def test_write_to_an_incorrect_address_is_invalid(cpu_bus: purenes.cpu.CPUBus):
